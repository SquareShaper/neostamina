...
public class EntityAttributesMixin {
    static {
        ...
        Neostamina.ROWING_LAND_TICK_STAMINA_COST = Registry.registerReference(Registries.ATTRIBUTE, Neostamina.id("generic.rowing_land_tick_stamina_cost"), new ClampedEntityAttribute("attribute.name.generic.rowing_land_tick_stamina_cost", 0F, 0.0F, 65536.0F).setTracked(true));
        Neostamina.ROWING_WATER_TICK_STAMINA_COST = Registry.registerReference(Registries.ATTRIBUTE, Neostamina.id("generic.rowing_water_tick_stamina_cost"), new ClampedEntityAttribute("attribute.name.generic.rowing_water_tick_stamina_cost", 0F, 0.0F, 65536.0F).setTracked(true));
        Neostamina.ROWING_ICE_TICK_STAMINA_COST = Registry.registerReference(Registries.ATTRIBUTE, Neostamina.id("generic.rowing_ice_tick_stamina_cost"), new ClampedEntityAttribute("attribute.name.generic.rowing_ice_tick_stamina_cost", 0F, 0.0F, 65536.0F).setTracked(true));
