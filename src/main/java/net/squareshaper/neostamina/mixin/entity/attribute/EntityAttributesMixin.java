...
public class EntityAttributesMixin {
    static {
        ...
        Neostamina.MAX_STAMINA_CHANGE = Registry.registerReference(Registries.ATTRIBUTE, Neostamina.id("generic.max_stamina_change"), new ClampedEntityAttribute("attribute.name.generic.max_stamina_change", 1.0F, 0.0F, 1024.0F).setTracked(true));
